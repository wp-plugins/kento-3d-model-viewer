...
3. Use this shortcode to post or page `[model_3d width="500" height="400" source="http://example.com/models/sample-model.obj" ]`
4. 3d texture file and .obj must contain same folder and same server
